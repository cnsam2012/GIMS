...
//import me.chang.gpms.dao.elasticsearch.ReportRepository;
...
//     * @param post
//     */
//    public void saveReport(Report post) {
//        reportRepository.save(post);
//    }
//
//    /**
...
//     * @return
//     */
//    public Page<Report> searchReport(String keyword, int current, int limit) {
...
//                ).build();
//
//        return elasticsearchTemplate.queryForPage(searchQuery, Report.class, new SearchResultMapper() {
//            @Override
