...
import me.chang.gpms.dao.CommentMapper;
...
public class CommentService {
    ...
    public int addComment(Comment comment) {
        ...
        if (comment.getEntityType() == BbEntityType.ENTITY_TYPE_POST.value()) {
            int count = commentMapper.selectCountByEntity((int) comment.getEntityType(), (int) comment.getEntityId());
            reportService.updateCommentCount((int) comment.getEntityId(), count);
        }
