 ...
 */
@Slf4j
@Schema(description = "分页与排序方式与用户ID接受对象", name = "PageAndOrderModeAndUserIdRo")
public class PageAndOrderModeAndUserIdRo {
    @Schema(description = "用户ID", example = "0", name = "id")
    private int id;
    ...
    @Schema(description = "排序方式", example = "0", name = "orderMode")
